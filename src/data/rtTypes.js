...
export const AREAS_ATUACAO = [
  ...
  },
  {
    ...
    documentosObrigatorios: [
      ...
      { nome: "Ficha de Testes de Recepção do Leite (Alizarol, Adulterantes, Crioscopia)", ref: "RIISPOA", critico: true },
      { nome: "Registros Térmicos de Pasteurização e Lavagem CIP", ref: "RIISPOA", critico: true },
      { nome: "Plano de Gerenciamento de Resíduos (PGRS/PGRSS)", ref: "RDC ANVISA 222/2018", critico: true },
      { nome: "Plano de Controle Integrado de Vetores e Pragas Urbanas (com mapas/laudos)", ref: "RDC ANVISA 275/2002", critico: true },
    ],
  },
  {
    id: "industria_poa",
    ...
    documentosObrigatorios: [
      ...
      { nome: "Plano de Gerenciamento de Resíduos (PGRS/PGRSS)", ref: "RDC ANVISA 222/2018", critico: true },
      { nome: "Plano de Controle Integrado de Vetores e Pragas Urbanas (com mapas/laudos)", ref: "RDC ANVISA 275/2002", critico: true },
      { nome: "Fichas de Eficácia de Insensibilização e Sangria (se aplicável)", ref: "IN MAPA", critico: true },
      { nome: "Planilhas de Maturação e Contaminação Gastrointestinal", ref: "IN MAPA", critico: true },
    ],
  },
  {
    ...
    documentosObrigatorios: [
      ...
      { nome: "Fichas Técnicas dos Produtos e Rotulagem (Cortes, Temperados)", ref: "RTIQ", critico: true },
      { nome: "Ficha de Recebimento de Matéria-Prima (Carimbos SIF/SIE/SIM, Temperatura)", ref: "RDC ANVISA 216/2004", critico: true },
      { nome: "Ficha de Controle de Temperatura (Câmaras, Balcões Expositores e Salas)", ref: "RDC ANVISA 216/2004", critico: true },
      { nome: "Ficha de Controle de Lotes e Moagem de Carne", ref: "VISA Estadual/Municipal", critico: true },
      { nome: "Ficha de Monitoramento da Água (Teor de Cloro e pH)", ref: "Portaria MS 888/2021", critico: true },
    ],
  },
  {
  ...
  },
  {
    ...
    documentosObrigatorios: [
      { nome: "Calendário Sanitário e Atestados Oficiais (Vacinação)", ref: "IN MAPA 48/2013", critico: true },
      { nome: "Livro/Ficha de Controle Sanológico e Farmacológico (com Período de Carência)", ref: "IN MAPA 48/2013", critico: true },
      { nome: "Protocolos e Checklist de Biosseguridade e Bem-Estar Animal", ref: "Lei 9.605/98", critico: true },
      { nome: "Fichas de Controle Reprodutivo e Zootécnico (IATF, Andrológicos)", ref: null, critico: false },
      { nome: "Guias de Trânsito Animal (GTA) — Emissão e Arquivamento", ref: "IN MAPA 281/2019", critico: true },
