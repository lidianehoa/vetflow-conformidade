...
export const CHECKLISTS = {
  ...
  PA_CK_04: {
    ...
    itens: [
      ...
      { id:"PA_CK_04_10", categoria:"Documentação",     desc:"Termo de responsabilidade assinado pelo Responsável pelo Animal de cada animal",       criterio:"Documento arquivado com informações de saúde e autorização",        class:"MAIOR",   peso:5 },
    ],
    acoesCorretivas: [
      "Isolar imediatamente animal com sinais de sofrimento ou doença",
      "Contatar Responsável pelo Animal em caso de alteração clínica relevante",
...
// ════════════════════════════════════════════════════════════════
  ...
  CH_CK_01: {
    ...
    itens: [
      ...
      { id:"CH_CK_01_02", categoria:"Documentação de Entrada",   desc:"Ficha de admissão preenchida e termo de responsabilidade assinado pelo Responsável pelo Animal?",    class:"CRÍTICO", peso:10 },
      ...
      { id:"CH_CK_01_08", categoria:"Bem-Estar",                 desc:"Alimentação fornecida conforme ficha do Responsável pelo Animal (ração/horário correto)?",            class:"MAIOR",   peso:5 },
    ...
    acoesCorretivas: [
      ...
      "Comunicar o Responsável pelo Animal imediatamente em caso de intercorrência",
